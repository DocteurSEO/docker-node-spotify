...
exercice sympathique qu’utilise l’API Spotify. Pour le lancer, assurez-vous d’avoir __Docker__ installé dans votre ordinateur.
...
__. un conteneur NodeJS Express pour la gestion de l’API__   
__. un conteneur React-Redux avec TypeScript (côté client)__   
__. un conteneur Redis pour la mise en place du cash__   
__. un conteneur NGNIX qui fait office de proxi__   
